...
CREATE TABLE `reginfotable` (
  ...
  `testinfoRoom_id` int NOT NULL COMMENT '关联表id',
  `ticketnum` varchar(12) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '准考证号',
  ...
  KEY `reginfotable_FK` (`testinfoRoom_id`),
  CONSTRAINT `reginfotable_FK` FOREIGN KEY (`testinfoRoom_id`) REFERENCES `testinforoom` (`testinfoRoom_id`),
  CONSTRAINT `tickettable_FK` FOREIGN KEY (`user_id`) REFERENCES `usertable` (`user_id`)
...
INSERT INTO `reginfotable` VALUES (104,564,379,'223795640115',0,'2022-02-22 16:04:57'),(105,563,384,'223845630322',1,'2022-02-22 16:06:48');
...
--
-- Table structure for table `testinforoom`
--

DROP TABLE IF EXISTS `testinforoom`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `testinforoom` (
  `testinfoRoom_id` int NOT NULL AUTO_INCREMENT COMMENT '关联id',
  `testinfo_id` int NOT NULL COMMENT '已发布考试id',
  `room_id` int NOT NULL COMMENT '考场id',
  `rquota` int NOT NULL COMMENT '考试名额',
  PRIMARY KEY (`testinfoRoom_id`),
...
--
-- Dumping data for table `testinforoom`
--

LOCK TABLES `testinforoom` WRITE;
/*!40000 ALTER TABLE `testinforoom` DISABLE KEYS */;
INSERT INTO `testinforoom` VALUES (274,48,65,152),(275,48,66,666),(276,48,67,666),(277,48,68,300),(278,48,69,300),(279,48,70,300),(280,48,71,300),(281,48,72,300),(282,48,73,300),(283,48,74,300),(284,48,75,300),(285,48,76,300),(286,48,77,300),(288,48,79,300),(289,48,80,300),(290,48,81,300),(291,48,82,300),(292,48,83,300),(293,48,84,300),(294,48,85,300),(295,48,86,300),(296,48,87,300),(297,48,88,300),(298,48,89,300),(299,48,90,300),(300,48,91,300),(301,48,92,300),(302,48,93,300),(303,48,94,300),(304,48,95,300),(305,48,96,300),(306,48,97,300),(307,48,98,300),(308,48,99,300),(309,48,100,300),(310,48,101,300),(311,48,102,300),(312,48,103,300),(313,48,104,300),(314,48,105,300),(315,48,106,300),(316,48,107,300),(317,48,108,300),(318,48,109,300),(319,48,110,300),(320,48,111,300),(321,48,112,300),(322,48,113,300),(323,48,114,300),(324,48,115,300),(325,48,116,300),(326,48,117,300),(327,48,118,300),(328,48,119,300),(329,48,120,300),(331,48,122,300),(332,48,123,300),(336,49,66,300),(337,49,67,300),(338,49,68,300),(339,49,69,300),(340,49,70,300),(341,49,71,300),(342,49,72,300),(343,49,73,300),(344,49,74,300),(345,49,75,300),(346,49,76,300),(347,49,77,300),(348,49,78,300),(349,49,81,300),(350,49,82,300),(351,49,83,0),(354,49,79,0),(355,49,65,20),(357,49,85,300),(358,49,86,300),(360,48,124,300),(361,49,88,300),(362,48,125,300),(364,49,84,300),(365,49,87,300),(366,49,89,300),(367,49,90,300),(372,48,121,300),(373,48,78,300),(374,51,65,300),(375,51,66,300),(376,51,67,2),(377,51,68,5),(378,51,69,0),(379,51,70,299),(380,51,71,300),(381,51,72,300),(382,51,73,300),(383,51,74,300),(384,51,75,299);
/*!40000 ALTER TABLE `testinforoom` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `testinfotable` VALUES (48,47,'2022-02-22 11:13:00','2022-02-22 13:12:00','2022-02-22 11:17:00',123),(49,40,'2022-02-05 11:23:00','2022-02-22 11:26:00','2022-02-22 14:23:00',30),(51,55,'2022-04-22 16:00:00','2022-02-22 16:00:00','2022-03-22 16:00:00',550);
...
INSERT INTO `usertable` VALUES (563,'123456199907050002','123456','边晓璐','20220222164820439.jpg'),(564,'123456200003110001','123456','邓淞文','20220222160336129.jpg');
/*!40000 ALTER TABLE `usertable` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping routines for database 'flpt'
--
...
-- Dump completed on 2022-02-22 17:55:42
