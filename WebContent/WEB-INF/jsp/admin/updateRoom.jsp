	...
	<form:form action="adminRoom/updateRoom" onsubmit="return doInputTest();" method="post" modelAttribute="room">
		<table>
			...
			<tr>
				...
				<td>
					<form:input path="rname" value="${room.rname}"/>
				</td>
			</tr>
			<tr>
				<td>考场地址<font color="red">*</font></td>
				<td>
					<form:input path="raddress" value="${room.raddress}"/>
				</td>
			</tr>
			<tr>
				<td>考场联系电话<font color="red">*</font></td>
				<td>
					<form:input path="rtelnum" value="${room.rtelnum}"/>
				</td>
			</tr>
			<tr>
				<td>邮编<font color="red">*</font></td>
				<td>
					<form:input path="rpostcode" value="${room.rpostcode}"/>
				</td>
			</tr>
			<tr>
				<td>&nbsp;</td>
